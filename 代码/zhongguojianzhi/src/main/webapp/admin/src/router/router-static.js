...
import center from '@/views/center'
    ...
    import jianzhishipin from '@/views/modules/jianzhishipin/list'
    ...
    import dictionaryJianzhishipin from '@/views/modules/dictionaryJianzhishipin/list'
...
const routes = [{
    ...
    ,{
        path: '/dictionaryJianzhishipin',
        name: '视频类型',
        component: dictionaryJianzhishipin
    }
    ,{
        path: '/dictionaryNews',
        name: '剪纸历史类型',
