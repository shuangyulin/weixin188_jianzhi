        ...
        <form class="app-update-pv">
            <view
                ...
                <input   disabled
                         ...
                         :disabled="ro.goodsName" type="text" v-model="ruleForm.goodsName" placeholder="商品名称"></input>
            </view>
                <view
                        ...
                        class="cu-form-group" @tap="goodsPhotoTap">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"#f06f4f","textAlign":"left"}'
                    ...
                    <view class="right-input" style="padding:0;textAlign:left">
                        <image
                                ...
                                class="avator" v-if="ruleForm.goodsPhoto" :src="ruleForm.goodsPhoto" mode="aspectFill">
                        </image>
                    ...
                    <picker @change="goodsTypesChange" :value="goodsTypesIndex" :range="goodsTypesOptions" range-key="indexName">
                        <view
                                :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#f06f4f","borderRadius":"0px","color":"#f06f4f","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"24rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                                class="uni-input">{{ruleForm.goodsTypes?ruleForm.goodsValue:"请选择商品类型"}}</view>
                    </picker>
                </view>
                <view
                        :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"88rpx"}'
                    ...
                    <input   disabled
                             :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#f06f4f","borderRadius":"0px","color":"#f06f4f","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"24rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                             :disabled="ro.goodsKucunNumber" type="number" v-model="ruleForm.goodsKucunNumber" placeholder="商品库存"></input>
                </view>
                <view
                        :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"88rpx"}'
                        class="cu-form-group">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"#f06f4f","textAlign":"left"}'
                          class="title">点击次数</view>
                    <input   disabled
                             :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#f06f4f","borderRadius":"0px","color":"#f06f4f","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"24rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                             :disabled="ro.goodsClicknum" type="number" v-model="ruleForm.goodsClicknum" placeholder="点击次数"></input>
                </view>
<!-- text后缀 -->
            <view
                ...
                <textarea :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#f06f4f","borderRadius":"0px","color":"#f06f4f","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"24rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx","height":"200rpx"}'
                          :disabled="ro.goodsContent" v-model="ruleForm.goodsContent" placeholder="商品简介"/>
            </view>
...
<script>
    ...
    export default {
		...
		/*下拉框*/
			let goodsTypesParams = {
                page: 1,
                limit: 100,
                dicCode: 'goods_types',
            }
			let goodsTypes = await this.$api.page(`dictionary`, goodsTypesParams);
			this.goodsTypesOptions = goodsTypes.data.list
		/*下拉框*/
            ...
            if (options.id) {
                ...
                // 获取信息
                let res = await this.$api.info(`goods`, this.ruleForm.id);
        ...
        methods: {
            // 下拉变化
            goodsTypesChange(e) {
                this.goodsTypesIndex = e.target.value
                this.ruleForm.goodsValue = this.goodsTypesOptions[this.goodsTypesIndex].indexName
                this.ruleForm.goodsTypes = this.goodsTypesOptions[this.goodsTypesIndex].codeIndex
            },
			...
			goodsPhotoTap() {
                ...
                this.$api.upload(function(res) {
                    _this.ruleForm.goodsPhoto = _this.$base.url + 'upload/' + res.file;
                    _this.$forceUpdate();
                    _this.$nextTick(() => {
                        // _this.styleChange()
                    })
            ...
            async onSubmitTap() {
				...
				if ((!this.ruleForm.goodsPhoto)) {
                    this.$utils.msg(`商品照片不能为空`);
                    return
                }
				if ((!this.ruleForm.goodsKucunNumber) && (!this.$validate.isIntNumer(this.ruleForm.goodsKucunNumber)) && this.ruleForm.goodsKucunNumber >0) {
                    this.$utils.msg(`商品库存不能为空，不能小于0 格式为数字`);
                    return
                }
				if ((!this.ruleForm.goodsClicknum) && (!this.$validate.isIntNumer(this.ruleForm.goodsClicknum)) && this.ruleForm.goodsClicknum >0) {
                    this.$utils.msg(`点击次数不能为空，不能小于0 格式为数字`);
                    return
                }
                if (this.ruleForm.id) {
                    await this.$api.update(`goods`, this.ruleForm);
                } else {
                    await this.$api.save(`goods`, this.ruleForm);
                }
