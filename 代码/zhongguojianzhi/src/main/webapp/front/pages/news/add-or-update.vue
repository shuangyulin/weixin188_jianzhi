        ...
        <form class="app-update-pv">
            <view
                ...
                <input   disabled
                         ...
                         :disabled="ro.newsName" type="text" v-model="ruleForm.newsName" placeholder="剪纸历史标题"></input>
            </view>
                <view
...
<!-- text后缀 -->
            <view
                ...
                <textarea :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#f06f4f","borderRadius":"0px","color":"#f06f4f","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"24rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx","height":"200rpx"}'
                          :disabled="ro.newsContent" v-model="ruleForm.newsContent" placeholder="剪纸历史详情"/>
            </view>
        ...
        methods: {
            ...
            async onSubmitTap() {
				if ((!this.ruleForm.newsName)) {
                    this.$utils.msg(`剪纸历史标题不能为空`);
                    return
                }
				if ((!this.ruleForm.newsPhoto)) {
                    this.$utils.msg(`剪纸历史图片不能为空`);
                    return
                }
                if (this.ruleForm.id) {
